...
export class PublicConfigService {
  ...
  getPaymentInstructions() {
    return {
      ...
      accountHolder: this.configService.getOrThrow<string>('PAYMENT_ACCOUNT_HOLDER'),
      accountNumber: this.configService.getOrThrow<string>('PAYMENT_ACCOUNT_NUMBER'),
      clabe: this.configService.getOrThrow<string>('PAYMENT_CLABE'),
      referenceHint: this.configService.getOrThrow<string>('PAYMENT_REFERENCE_HINT'),
      businessWhatsapp:
